...
The feature extraction block operates on a 4‑channel input constructed from the preprocessed CSI frames (see Section~\ref{sec:preprocessing}). The layers include:
\begin{itemize}
